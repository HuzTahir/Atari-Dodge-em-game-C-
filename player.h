...
void handleInput(Box& smallBoxes)
{
    ...
    // if ((globalBounds.left + globalBounds.width <= 100 && smallBoxes.directionX == -1) ||
    //     (globalBounds.left >= 720 && smallBoxes.directionX == 1) ||
    //     ((globalBounds.top >= 260 && globalBounds.top <= 440) && smallBoxes.directionY == 1) ||
    //     ((globalBounds.top >= 510 && globalBounds.top <= 730) && smallBoxes.directionY == -1))
    // {
    //     // Stop movement in the x-axis direction
    //     smallBoxes.directionX = 0;
    //     smallBoxes.directionY = 0;
    // }

    // if (((globalBounds.left >= 40 && globalBounds.left < 340) || (globalBounds.left >= 410 && globalBounds.left < 710)) &&
    //     (globalBounds.top <= 250 && smallBoxes.directionY == -1))
    // {
    //     // Stop movement in the y-axis direction
    //     smallBoxes.directionY = 0;
    //     smallBoxes.directionX = 0;
    // }

    // if (((globalBounds.left >= 40 && globalBounds.left < 340) || (globalBounds.left >= 410 && globalBounds.left < 710)) &&
    //     (globalBounds.top >= 720 && smallBoxes.directionY == 1))
    // {
    //     // Stop movement in the y-axis direction
    //     smallBoxes.directionY = 0;
    //     smallBoxes.directionX = 0;
