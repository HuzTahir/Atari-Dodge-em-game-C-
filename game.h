...
public:
    ...
    void start_game()
    {
        ...
        // R = new RedRectangle[numRed]{
        //     RedRectangle(200, 200),
        //     RedRectangle(200, 300),
        //     RedRectangle(200, 400),
        //     RedRectangle(200, 500),
        //     RedRectangle(200, 600)};
        bool speed = false;
        int numRed = 0;
        int numGreen = 0;
        int numOrange = 0;
        ...
        // F1[0] = new RedRectangle(200, 230);
        // F1[1] = new RedRectangle(250, 230);
        // F1[2] = new RedRectangle(300, 230);
        // F1[3] = new RedRectangle(350, 230);
        // F1[4] = new RedRectangle(400, 230);
        if (level == 1)
        {
            for (int i = 0; i < 8; ++i)
            {
        ...
        while (window.isOpen())
        {
            ...
            if (gamestart)
            {
                ...
                FloatRect e3Bounds[numRed];
                FloatRect greenBounds[numGreen];
                FloatRect orangeBounds[numOrange];
                FloatRect whiteBounds[numWhite];
                ...
                for (int i = 0; i < numSmallBoxes; ++i)
                {
                    ...
                    if (timer > 3)
                    {
                        ...
                        smallBoxes[1].move(speedX = 0.1f, speedY = 0.1f);
                        smallBoxes[2].move(speedX = 0.1f, speedY = 0.1f);
                    }
                    ...
                    if (smallBoxes[i].shape.getPosition().y + smallBoxes[i].shape.getSize().y > window.getSize().y ||
